...
export function collectElements(documentRef = document) {
  const elements = {
    ...
    collectSignatureToggle: byId(documentRef, "collectSignatureToggle"),
    collectMissingContactToggle: byId(documentRef, "collectMissingContactToggle"),
    ...
    generatedPayloadPanel: byId(documentRef, "generatedPayloadPanel"),
    generatedPayloadText: byId(documentRef, "generatedPayloadText"),
